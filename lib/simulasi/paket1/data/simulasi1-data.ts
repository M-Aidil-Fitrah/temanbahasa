export const simulasiPaket1Data = [
  // ========================
  ...
  
  {
    ...
    optionsX: ["berisik", "ramai"],
    statementY: "Tidak. Kadang-kadang sepi.",
    optionsY: ["sunyi", "tenang"],
    correct: "B",
  ...
  },
  {
    ...
    optionsX: ["Sangat dingin cuaca hari ini", "Sangat dingin hari ini cuaca"],
    statementY: "Benar. Kemarin padahal panas sekali.",
    optionsY: ["Padahal, kemarin panas sekali", "Panas sekali padahal, kemarin"],
    correct: "C",
  ...
  },
  {
    ...
    optionsX: ["Pos Pelayanan Terpadu (Posyandu)", "pos pelayanan terpadu (Posyandu)"],
    statementY: "adalah imunisasi yang penting untuk tumbuh kembang anak - anak.",
    optionsY: ["tumbuh kembang anak-anak", "tumbuh kembang anak - anak"],
    correct: "C",
  ...
  },
  {
    ...
    optionsX: ["yaitu dasar", "merupakan landasan"],
    statementY: "yang terdiri dari lima sila.",
    optionsY: ["tersusun atas", "terdiri atas"],
    correct: "D",
  ...
  },
  {
    ...
    optionsX: ["Dengan diberikan kayu manis sedikit", "Memberikan sedikit bubuk kayu manis"],
    statementY: "maka menambah cita rasa minuman tersebut.",
    optionsY: ["bertambahlah cita rasa minuman tersebut", "maka minuman tersebut cita rasanya bertambah"],
    correct: "C",
  ...
  },
  {
    ...
    optionsY: ["pagi", "siang"],
    correct: "D",
    explanation: "Lokasi di Jalan Asoka dan waktu pukul 09.00 hingga selesai (siang)."
  },
  {
    id: "P1-S2-008",
    section: "kaidah",
    statementX: "Siapa nama ibu si anak?",
    optionsX: ["Putri.", "Sofia."],
    statementY: "Nama bayi perempuan yang cocok adalah .....",
    optionsY: ["Jamila.", "Bunga."],
    correct: "D",
  ...
  },
  {
    ...
    optionsX: ["Rumah Sakit", "rumah sakit"],
    statementY: "Dokter memberikan resep obat kepada pasien.",
    optionsY: ["Dokter", "dokter"],
    correct: "B",
  ...
  },
  {
    ...
    optionsX: ["sayur - sayuran", "sayur-sayuran"],
    statementY: "Anak-anak bermain di taman.",
    optionsY: ["Anak - anak", "Anak-anak"],
    correct: "D",
  ...
  },
  {
    ...
    optionsX: ["bekerja sama", "bekerjasama"],
    statementY: "Kami harus saling tolong-menolong.",
    optionsY: ["tolong-menolong", "tolong menolong"],
    correct: "C",
  ...
  },
  {
    ...
    optionsX: ["di perpustakaan", "diperpustakaan"],
    statementY: "Kami belajar ke sekolah setiap hari.",
    optionsY: ["ke sekolah", "kesekolah"],
    correct: "A",
  ...
  },
  {
    ...
    optionsX: ["Presiden", "presiden"],
    statementY: "Menteri pendidikan memberikan sambutan.",
    optionsY: ["Menteri Pendidikan", "menteri pendidikan"],
    correct: "A",
  ...
  },
  {
    ...
    optionsX: ["hari Senin", "Hari Senin"],
    statementY: "Acara dimulai pada bulan Januari.",
    optionsY: ["bulan Januari", "Bulan Januari"],
    correct: "A",
  ...
  },
  {
    ...
    optionsX: ["jalan Sudirman", "Jalan Sudirman"],
    statementY: "Kantor berada di Jalan Thamrin.",
    optionsY: ["jalan Thamrin", "Jalan Thamrin"],
    correct: "B",
  ...
  },
  {
    ...
    optionsX: ["17 Agustus 1945", "17 agustus 1945"],
    statementY: "Sumpah Pemuda diperingati setiap 28 Oktober.",
    optionsY: ["28 Oktober", "28 oktober"],
    correct: "A",
  ...
  },
  {
    ...
    optionsX: ["di Jakarta", "diJakarta"],
    statementY: "Kakak kuliah ke Bandung.",
    optionsY: ["ke Bandung", "keBandung"],
    correct: "A",
  ...
  },
  {
    ...
    optionsX: ["sedang makan", "sedang me-makan"],
    statementY: "Kami akan berangkat besok.",
    optionsY: ["ber-angkat", "berangkat"],
    correct: "A",
  ...
  },
  {
    ...
    optionsX: ["tidak datang", "tak datang"],
    statementY: "Saya belum makan sejak pagi.",
    optionsY: ["belum makan", "tak makan"],
    correct: "A",
  ...
  },
  {
    ...
    optionsX: ["Ibu Guru", "ibu guru"],
    statementY: "Bapak kepala sekolah memberi pengumuman.",
    optionsY: ["Bapak Kepala Sekolah", "bapak kepala sekolah"],
    correct: "B",
  ...
  },
  {
    ...
    optionsX: ["Bahasa Indonesia", "bahasa Indonesia"],
    statementY: "Mereka fasih berbahasa inggris.",
    optionsY: ["berbahasa Inggris", "berbahasa inggris"],
    correct: "C",
  ...
  },
  {
    ...
    optionsX: ["sangat panas", "amat panas"],
    statementY: "Kemarin cuacanya sangat dingin sekali.",
    optionsY: ["sangat dingin sekali", "sangat dingin"],
    correct: "D",
  ...
  },
  {
    ...
    optionsX: ["Semua siswa", "Para siswa"],
    statementY: "Para murid-murid sedang belajar.",
    optionsY: ["Para murid", "Murid-murid"],
    correct: "C",
  ...
  },
  {
    ...
    optionsX: ["menonton televisi", "menonton TV"],
    statementY: "Kami membeli komputer baru.",
    optionsY: ["komputer", "computer"],
    correct: "A",
  ...
  },
  {
    ...
    optionsX: ["Antara saya dan dia", "Saya dan dia"],
    statementY: "Hal tersebut adalah tanggung jawab kita bersama-sama.",
    optionsY: ["kita bersama-sama", "kita bersama"],
    correct: "D",
  ...
  },
  {
    ...
    optionsX: ["lebih tinggi daripada", "lebih tinggi dari"],
    statementY: "Harga ini lebih murah dibanding yang lain.",
    optionsY: ["lebih murah dibanding", "lebih murah dibandingkan"],
    correct: "D",
  ...
  },
  {
    ...
    optionsX: ["telah tiba", "sudah tiba"],
    statementY: "Kami sudah mengerjakan tugas tersebut.",
    optionsY: ["sudah mengerjakan", "telah mengerjakan"],
    correct: "A",
  ...
  },
  {
    ...
    optionsX: ["izin untuk pergi", "minta izin pergi"],
    statementY: "Dia mohon diri untuk pulang lebih awal.",
    optionsY: ["mohon diri untuk pulang", "mohon diri pulang"],
    correct: "D",
  ...
  },
  {
    ...
    optionsX: ["08.00 WIB", "08.00 wib"],
    statementY: "Rapat selesai pada pukul 12.00 WITA.",
    optionsY: ["12.00 WITA", "12.00 wita"],
    correct: "A",
  ...
  },
  {
    ...
    optionsX: ["adalah miliknya", "miliknya"],
    statementY: "Rumah ini merupakan kepunyaan kami.",
    optionsY: ["merupakan kepunyaan kami", "kepunyaan kami"],
    correct: "B",
